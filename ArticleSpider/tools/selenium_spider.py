...
#
# browser.get("https://juejin.im/")
# browser.find_element_by_css_selector("span.login").click()
# browser.find_element_by_css_selector(".input-box input[name='loginPhoneOrEmail']").send_keys("15605020969")
# browser.find_element_by_css_selector(".input-box input[name='loginPassword']").send_keys("jilonglong520")
#
# browser.find_element_by_css_selector(".auth-modal-box button.btn").click()
#selenium 完成微博模拟登录
